        ...
        <section class="event-details-card">
            <div class="event-card-actions-top">
                ...
                <?php if($isOwnerTop): ?>
                    <div class="event-actions-details">
                        <button class="btn invite-btn" onclick="openInviteModal(<?php echo e($event->id); ?>, '<?php echo e($event->eventName); ?>')">Inviter</button>
                    ...
                    <div class="rsvp-menu" id="rsvp-menu-event">
                        ...
                        <div class="rsvp-menu-list" role="menu">
                            <form action="<?php echo e(route('events.rsvp', ['eventId' => $event->id])); ?>" method="POST">
                                ...
                                <button type="submit" class="rsvp-menu-item accepted" <?php echo e($isFullTop ? 'disabled' : ''); ?>>
            ...
            <ul class="event-details-list">
                ...
                <li>
                    ...
                    <span class="event-details-value"><?php echo e($start ? $start->translatedFormat('l d. F Y') . ' kl. ' . $start->format('H:i') : '-'); ?></span>
                </li>
                <li>
            ...
            ?>
            <?php if(!$isOwner && session('success')): ?>
    ...
    <div id="delete-modal" class="confirm-modal" role="dialog" aria-modal="true" aria-labelledby="confirm-title" style="display:none;">
        <div class="confirm-modal-content">
            ...
            <div class="confirm-actions">
                ...
                <form id="delete-event-form" action="<?php echo e(url('/events/delete/'.$event->id)); ?>" method="POST" style="display:inline;">
                    <?php echo csrf_field(); ?>
