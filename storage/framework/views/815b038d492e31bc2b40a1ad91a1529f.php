    ...
    <div class="header-left">
        ...
        <nav class="navigation" id="main-nav">
            <ul>
                ...
                <li><a href="/events" class="<?php echo e($currentPage == 'events' ? 'active' : ''); ?>">Events</a></li>
                <li><a href="/friends" class="<?php echo e($currentPage == 'friends' ? 'active' : ''); ?>">Friends</a></li>
            </ul>
        </nav>
    </div>
...
<script src="<?php echo e(asset('js/theme-toggle.js')); ?>"></script> <!-- Global dark/light mode toggle -->
<!-- New Event Modal -->
...
<?php /**PATH C:\Users\Tobia\Documents\GitHub\TaskM8\resources\views/partials/header.blade.php ENDPATH**/ ?>