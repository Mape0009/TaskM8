            ...
            <div class="event-list">
                ...
                <div class="event-card">
                    <div class="event-header">
                        ...
                        <h3>Monthly Team Sync</h3>
                    </div>
                    <p class="event-description">A recurring meeting to align on project progress and upcoming tasks.</p>
                    <div class="event-actions">
                        <a href="/events/1" class="btn primary-btn">View Details</a>
                        <button class="btn secondary-btn">Edit <svg class="icon arrow-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7"></path></svg></button>
                    </div>
                </div>
                ...
                <div class="event-card">
                    ...
                    <p class="event-description">Beers with the boys</p>
                    
                    <div class="event-actions">
                        <a href="/events/2" class="btn primary-btn">View Details</a>
                        <button class="btn secondary-btn">Edit <svg class="icon arrow-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7"></path></svg></button>
                    </div>
                </div>
            </div>
