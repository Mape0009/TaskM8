                        ...
                        <div class="event-actions">
                            ...
                            @auth
                                ...
                                @if(!$isOwner)
                                    ...
                                    {{-- @if($rsvpStatus === 'accepted')
                                    <button type="button" class="bin-button" aria-label="Forlad begivenhed" onclick="document.getElementById('leave-modal-{{ $event->id }}').style.display='flex'">
                                    ...
                                    <div id="leave-modal-{{ $event->id }}" class="confirm-modal" role="dialog" aria-modal="true" aria-labelledby="leave-confirm-title-{{ $event->id }}" style="display:none;">
                                        <div class="confirm-modal-content">
                                            <div class="confirm-modal-body">
                                                ...
                                                <p class="confirm-text">Vil du forlade dette begivenhed? Dette kan ikke fortrydes.</p>
                                            </div>
