...
<div id="cookie-consent" class="cookie-consent" aria-live="polite" aria-hidden="true" style="display:none;">
    ...
    <div class="card cookie-modal" role="dialog" aria-modal="true" aria-labelledby="cookie-title" aria-describedby="cookie-desc" tabindex="-1">
        ...
        <div style="text-align:left; margin-left:6px; flex:1;">
            <h3 id="cookie-title" class="cookie-title">Vi bruger cookies</h3>
            <p id="cookie-desc" class="cookie-desc">For at levere og sikre tjenesten bruger vi nødvendige cookies. Accepter venligst for at fortsætte. Læs vores <a href="{{ url('/cookiepolitik') }}">cookiepolitik</a>.</p>
        </div>
        <div style="display:flex; flex-direction:column; gap:10px; align-items:center; margin-left:12px;">
            <button id="cookie-accept" class="accept-button" aria-label="Accepter cookies">Accepter</button>
            <a href="{{ url('/cookiepolitik') }}" class="cookie-link" style="font-size:0.88rem; color:var(--accent,#6b46ff);">Læs politik</a>
        </div>
    </div>
</div>
